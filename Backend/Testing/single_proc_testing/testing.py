...
a = Node(Utils.randomIp(), Utils.randomPort(), 0)
b = Node(Utils.randomIp(), Utils.randomPort(), 1)
c = Node(Utils.randomIp(), Utils.randomPort(), 3)
d = Node(Utils.randomIp(), Utils.randomPort(), 6)
